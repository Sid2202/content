...
$output = '';
if ( ! empty( $categories ) ) {
    include_once WP_FREEIO_PLUGIN_DIR . '/includes/walkers/class-category-select-walker.php';

    $walker = new WP_Freeio_Category_Select_Walker();
...
// $output = WP_Freeio_Abstract_Filter::hierarchical_tax_option_tree(0, 0, $name, $key, $field, $selected );
