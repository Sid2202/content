...
class Google_Service_Freebase extends Google_Service
{
   ...
   * @opt_param float confidence Required confidence for a freelancer to match.
   ...
   * @opt_param int limit Maximum number of freelancers to return.
...
class Google_Service_Freebase_ReconcileFreelancer extends Google_Model
{
  ...
  public $mid;
  public $name;
  protected $notableType = 'Google_Service_Freebase_ReconcileFreelancerNotable';
  ...
  public function setNotable(Google_Service_Freebase_ReconcileFreelancerNotable $notable)
  {
...
class Google_Service_Freebase_ReconcileFreelancerNotable extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Google_Service_Freebase_ReconcileGet extends Google_Collection
{
  ...
  protected $freelancerType = 'Google_Service_Freebase_ReconcileFreelancer';
  protected $freelancerDataType = 'array';
  protected $costsType = 'Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'Google_Service_Freebase_ReconcileFreelancer';
  ...
  public function setMatch(Google_Service_Freebase_ReconcileFreelancer $match)
  {
    $this->match = $match;
  }
