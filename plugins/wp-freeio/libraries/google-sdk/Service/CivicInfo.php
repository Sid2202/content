...
class Google_Service_CivicInfo_Freelancer extends Google_Collection
{
  protected $collection_key = 'channels';
  protected $internal_gapi_mappings = array(
  );
  public $freelancerUrl;
  ...
  public function setFreelancerUrl($freelancerUrl)
  {
    $this->freelancerUrl = $freelancerUrl;
  }
  public function getFreelancerUrl()
  {
    return $this->freelancerUrl;
  }
...
class Google_Service_CivicInfo_Contest extends Google_Collection
{
  ...
  protected $freelancersType = 'Google_Service_CivicInfo_Freelancer';
  protected $freelancersDataType = 'array';
